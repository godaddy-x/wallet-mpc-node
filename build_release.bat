...
call :build_one darwin amd64 wallet-mpc-node-darwin-amd64
if %errorlevel% neq 0 goto :failed

call :build_one darwin arm64 wallet-mpc-node-darwin-arm64
if %errorlevel% neq 0 goto :failed
...
echo     wallet-mpc-node-darwin-amd64
echo     wallet-mpc-node-darwin-arm64
